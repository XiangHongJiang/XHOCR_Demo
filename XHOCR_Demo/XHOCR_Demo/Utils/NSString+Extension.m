...
- (UIImage *)stringToImage {
    NSArray *imageArray = [self componentsSeparatedByString:@","];
    NSData * imageData =[[NSData alloc] initWithBase64EncodedString:imageArray.lastObject options:NSDataBase64DecodingIgnoreUnknownCharacters];
